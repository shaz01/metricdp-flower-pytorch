"""Tests for the EuroSAT CIA round-matched AUC analysis."""
...
from experiments.cia.scripts.eurosat_scaling_analysis import (
...
def test_main_refuses_to_overwrite_existing_nonempty_analysis_when_summary_empty(
    ...
    monkeypatch.setattr(
        "sys.argv", ["eurosat_scaling_analysis", "--results-dir", str(results_dir)]
    )
