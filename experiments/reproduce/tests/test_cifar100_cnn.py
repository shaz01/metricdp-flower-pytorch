...
from experiments.reproduce.cifar100_cnn import Cifar100CNN


def test_cifar100_cnn_has_no_batchnorm() -> None:
...
def test_cifar100_cnn_parameter_count_matches_design() -> None:
    model = Cifar100CNN()
